...
It appears that observation 19 is an outlier as it is the only observation in Cluster 3. From the dendrogram this point significantly differs from the rest of the data, either due to measurement errors or for some other reasons. So we remove this outlier for further analysis.
