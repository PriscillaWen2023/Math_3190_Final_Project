...
url <- "https://github.com/cham24/Math_3190_Final_Project/raw/main/Studio%20Ghibli%20%5Bnew%5D.csv"
...
```{r basic_euclidean_diana, warning=F, eval=True, echo=True}
...
```{r diana()_merge_sequence, warning=F, eval=T, echo=T}
...
# Plot dendrogram
plot(best_hc_colored, main = "Dendrogram obtained by dissimilarity from euclidean distance")
```
...
best_hc2 <- diana(dist(data_no_outlier, method = "euclidean"))
clusters2 <- cutree(best_hc2, k = 4)  # Set the number of clusters to 3
