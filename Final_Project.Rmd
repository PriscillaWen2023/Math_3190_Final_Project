...
$$
S_i = (\dfrac{1}{T_i} \sum_{k=1}^{T_i}||X_j-A_i||_q^p)^{1/q}
$$

Here if $q=1$ then indeed it is the distance to the centroid, and usually $p=2$ , for a $2$-norm in euclidean distance. Other distance metrics of course may be used in the case of higher-dimensional data.
