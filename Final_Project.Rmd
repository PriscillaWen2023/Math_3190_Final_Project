...
Divisive or 'top-down' clustering algorithms have, by the past, been studied less extensively than bottom-up or agglomerative clustering (pg. 486, Hastie et al., 2009). They both are subject to some of the same drawbacks:

-   data points which were split at an early phase will not be reallocated
